<p align="center">
  <img src="https://raw.githubusercontent.com/bbeckley-hub/EnteroMark/main/enteromark.png " alt="EnteroMark Banner" width="100%">
</p>
...
### **A species-optimized computational pipeline for rapid, accessible *Enterococcus faecium* genotyping and surveillance**

#### **Complete VRE genomic analysis in minutes — not hours**

![Version](https://anaconda.org/bbeckley-hub/enteromark/badges/version.svg)
...
[![Docker Version](https://img.shields.io/docker/v/bbeckleyhub/enteromark?sort=semver)](https://hub.docker.com/r/bbeckleyhub/enteromark)
...
![Conda Downloads](https://img.shields.io/conda/dn/bioconda/enteromark?label=Conda%20Downloads)


[![Powered by 🧠](https://img.shields.io/badge/powered%20by-science%20🔬-purple)](https://github.com/bbeckley-hub/EnteroMark)
[![Coffee](https://img.shields.io/badge/built%20with-%E2%98%95%20coffee-orange)](https://github.com/bbeckley-hub/EnteroMark)
[![Made with ❤️](https://img.shields.io/badge/made%20with-%E2%9D%A4%EF%B8%8F-red)](https://github.com/bbeckley-hub/EnteroMark)
[![Open Source Love](https://badges.frapsoft.com/os/v1/open-source.svg?v=103)](https://github.com/ellerbrock/open-source-badges/)
[![Made for Research](https://img.shields.io/badge/made%20for-Research-0066cc.svg)](https://github.com/bbeckley-hub/EnteroMark)


[![Documentation](https://img.shields.io/badge/docs-mkdocs-526CFE?logo=materialformkdocs)](https://bbeckley-hub.github.io/EnteroMark)
[![RST Badge](https://img.shields.io/badge/documentation-RST-4CAF50.svg)](https://www.sphinx-doc.org/)
[![Last Commit](https://img.shields.io/github/last-commit/bbeckley-hub/EnteroMark)](https://github.com/bbeckley-hub/EnteroMark/commits)
[![Contributors](https://img.shields.io/github/contributors/bbeckley-hub/EnteroMark)](https://github.com/bbeckley-hub/EnteroMark/graphs/contributors)
...
[![CI](https://img.shields.io/github/actions/workflow/status/bbeckley-hub/EnteroMark/ci.yml?branch=main&label=CI)](https://github.com/bbeckley-hub/EnteroMark/actions)
[![Tests](https://img.shields.io/badge/tests-passing-brightgreen.svg)](https://github.com/bbeckley-hub/EnteroMark/tests)
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/bbeckley-hub/EnteroMark)

[![Speed](https://img.shields.io/badge/Speed-11%20min%2F24%20samples-FF6D00.svg)](https://github.com/bbeckley-hub/EnteroMark#performance-benchmarks)
[![VRE](https://img.shields.io/badge/Classifies-VRE%20%7C%20VSE-00BCD4.svg)](https://github.com/bbeckley-hub/EnteroMark)
[![AI Ready](https://img.shields.io/badge/AI-Ready%20Reports-00C853.svg)](https://github.com/bbeckley-hub/EnteroMark#ai-integration-guide)


[![Python 3.9+](https://img.shields.io/badge/python-3.9+-blue.svg)](https://www.python.org/downloads/)
[![Conda](https://img.shields.io/badge/conda-✓-green.svg)](https://docs.conda.io/en/latest/)
[![MIT License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![GitHub Issues](https://img.shields.io/github/issues/bbeckley-hub/EnteroMark)](https://github.com/bbeckley-hub/EnteroMark/issues)
[![GitHub Stars](https://img.shields.io/github/stars/bbeckley-hub/EnteroMark)](https://github.com/bbeckley-hub/EnteroMark/stargazers)
[![Sample Report](https://img.shields.io/badge/📊-View_Sample_Report-blue)](https://htmlpreview.github.io/?https://bbeckley-hub.github.io/EnteroMark/)
...
- [🐳 EnteroMark Docker Usage](#-enteromark-docker-usage)
...
# Complete in ~11-15 minutes! 🎉
```

---

## ENTEROMARK TERMINAL DISPLAY

```
usage: enteromark [-i INPUT] [-o OUTPUT] [-t THREADS] [--skip-qc] [--skip-mlst]
...
On HPC clusters that support [Singularity/Apptainer](https://sylabs.io/singularity/), you can run EnteroMark **without `sudo`** and output files will be owned by your user automatically.

> **Important:** EnteroMark writes temporary files inside its own installation directory (e.g., `/opt/enteromark/...`). Singularity mounts containers as read‑only by default, so you **must** add the `--writable-tmpfs` flag to allow these writes. The flag creates an ephemeral, writable overlay in memory – no permanent changes are made to the container.
...
# Output files are already owned by you – no chown needed!
```
...
singularity build enteromark.sif docker-archive://enteromark.tar
```

Now copy `enteromark.sif` to your HPC home or project directory (e.g., using `scp`).
...
| Flag | Purpose |
|------|---------|
| `--writable-tmpfs` | Creates a temporary writable overlay – **required** for EnteroMark to write intermediate files |
| `-B $(pwd):/data` | Binds your current directory to `/data` inside the container (input files read, output written) |
...
singularity run --writable-tmpfs -B $(pwd):/data enteromark.sif \
    -i "/data/*.fna" -o /data/output --threads 8 --skip-amr
```

### Verify it works

After a successful run, you will see output indicating each module completed. All result files in `./output` will be owned by **your HPC user** – no `sudo chown` needed. This is the cleanest way to run EnteroMark on shared HPC infrastructure.
...
| **PubMedST** | MLST allele database | [pubmlst.org](https://pubmlst.org/organisms/enterococcus-faecium) | Open access for research |
| **CARD** | Comprehensive Antibiotic Resistance Database | [card.mcmaster.ca](https://card.mcmaster.ca) | CC BY 4.0 |
| **ResFinder** | Acquired resistance genes | [cge.food.dtu.dk/services/ResFinder](https://cge.food.dtu.dk/services/ResFinder) | Academic free |
| **VFDB** | Virulence Factor Database | [mgc.ac.cn/VFs](http://www.mgc.ac.cn/VFs) | Free for research |
| **PlasmidFinder** | Plasmid replicon detection | [cge.food.dtu.dk/services/PlasmidFinder](https://cge.food.dtu.dk/services/PlasmidFinder) | Academic free |
...
enteromark -i sample.fna -o results --skip-qc --skip-abricate
```
...
EnteroMark generates a comprehensive, organized output directory:
...
2. **Open your report**: `enteromark_ultimate_report.html`
3. **Upload the JSON file** (`enteromark_ultimate_report.json`) to the AI
...
1. `conda activate enteromark`
2. `abricate --version` (should show 1.2.0+)
3. `enteromark --update-amr-db`
4. `enteromark --help`
5. Run test with single genome

### **Getting Help**
1. **Check existing issues**: [GitHub Issues](https://github.com/bbeckley-hub/EnteroMark/issues)
...
### Core EnteroMark Code
The EnteroMark pipeline code (the workflow engine, report generation, HTML templates, and Python modules written by the authors) is licensed under the **MIT License** – see the [LICENSE](LICENSE) file for details.
...
## **🚀 Ready to revolutionize your VRE analysis?**
...
[![Get Started CLI](https://img.shields.io/badge/GET_STARTED_CLI-Now-green?style=for-the-badge&logo=terminal)](https://github.com/bbeckley-hub/EnteroMark#-quick-start-cli)
[![Docker Hub](https://img.shields.io/badge/DOCKER_HUB-Pull-blue?style=for-the-badge&logo=docker)](https://hub.docker.com/r/bbeckleyhub/enteromark)
[![Report Issue](https://img.shields.io/badge/REPORT_ISSUE-Here-red?style=for-the-badge&logo=github)](https://github.com/bbeckley-hub/EnteroMark/issues)
